...
export function exportZEOComprehensiveExcel(schools: School[]): void {
  const headers = [
    ...
    'Next Inspection Due',
    'Active School Facilities',
    'HOI Problem 1 - Category',
    'HOI Problem 1 - Title',
    'HOI Problem 1 - Detailed Description',
    'HOI Problem 1 - Priority & Status',
    'HOI Problem 2 - Category',
    'HOI Problem 2 - Title',
    'HOI Problem 2 - Detailed Description',
    'HOI Problem 2 - Priority & Status',
    'HOI Problem 3 - Category',
    'HOI Problem 3 - Title',
    'HOI Problem 3 - Detailed Description',
  ...
  const rows = schools.map((s, idx) => {
    ...
    return [
      ...
      escape(s.level),
      escape(s.gender),
      escape(s.address || `${s.name}, Gurez`),
      escape(s.shift || 'Standard Day'),
      s.rating || 4.5,
      ...
      s.totalStudents,
      s.classWise?.kg?.male ?? 0,
      s.classWise?.kg?.female ?? 0,
      s.classWise?.grade1?.male ?? 0,
      s.classWise?.grade1?.female ?? 0,
      s.classWise?.grade2?.male ?? 0,
      s.classWise?.grade2?.female ?? 0,
      s.classWise?.grade3?.male ?? 0,
      s.classWise?.grade3?.female ?? 0,
      s.classWise?.grade4?.male ?? 0,
      s.classWise?.grade4?.female ?? 0,
      s.classWise?.grade5?.male ?? 0,
      s.classWise?.grade5?.female ?? 0,
      s.classWise?.grade6?.male ?? 0,
      s.classWise?.grade6?.female ?? 0,
      s.classWise?.grade7?.male ?? 0,
      s.classWise?.grade7?.female ?? 0,
      s.classWise?.grade8?.male ?? 0,
      s.classWise?.grade8?.female ?? 0,
      s.classWise?.grade9?.male ?? 0,
      s.classWise?.grade9?.female ?? 0,
      s.classWise?.grade10?.male ?? 0,
      s.classWise?.grade10?.female ?? 0,
      ...
      escape(plan?.uniformAssistanceStatus || 'Distributed (DBT / Physical)'),
      ...
      escape(s.lastInspectionDate || '2026-06-15'),
      escape(s.nextInspectionDue || '2026-11-20'),
      escape((s.facilities || []).join('; ')),
      escape(p1?.category || 'N/A'),
      escape(p1?.title || 'None'),
      escape(p1?.description || 'No Problem Logged'),
      escape(p1 ? `[${p1.priority}] ${p1.status}` : 'N/A'),
      escape(p2?.category || 'N/A'),
      escape(p2?.title || 'None'),
      escape(p2?.description || 'No Problem Logged'),
      escape(p2 ? `[${p2.priority}] ${p2.status}` : 'N/A'),
      escape(p3?.category || 'N/A'),
      escape(p3?.title || 'None'),
      escape(p3?.description || 'No Problem Logged'),
  ...
  link.setAttribute('download', `ZEO_Gurez_Master_Excel_Registry_92_Schools_${new Date().toISOString().slice(0, 10)}.csv`);
